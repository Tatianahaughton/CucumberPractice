...
public class LoginSteps extends CommonMethods {
   // WebDriver driver; isnt needed once commonmethods is extended
    ...
    public void user_enters_valid_username_and_valid_password() {
      //  LoginPage login=new LoginPage();
        //no need for creating login object after adding it in Common methods
       // WebElement usernameField = driver.findElement(By.id("txtUsername"));
       // usernameField.sendKeys(ConfigReader.getPropValue("username"));
        sendText(login.usernameTextField,ConfigReader.getPropValue("username"));

      //  WebElement passwordField = driver.findElement(By.id("txtPassword"));
       // passwordField.sendKeys(ConfigReader.getPropValue("password"));
        sendText(login.passwordTextField,ConfigReader.getPropValue("password"));
